# JH.R
# This file contains the R code used to process the raw accelerometer data of JH
# This file contains the R code used to process the event data of JH
...
#+ Import data
acc = read.csv("Data/Raw/Temp/Accel/JH.csv")
...
write.csv(acc, file = "Data/Raw/Accel/JH.csv")
